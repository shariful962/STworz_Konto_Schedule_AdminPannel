  ...
  return (
    <div className="p-4 font-Roboto h-screen bg-white overflow-hidden">
      ...
      <div className="flex md:items-center justify-between flex-col md:flex-row gap-3">
        <h1 className="font-semibold text-textClr text-[2rem] mt-9 md:mt-0">
          {t("dashboard.title")}
        </h1>
      ...
      {/* Stats */}
      <div className="flex flex-col md:flex-row items-center justify-between gap-3 md:gap-8 mt-3 md:mt-8.5">
        <div className="bg-[#F4F4F4] w-full md:w-1/2 px-2 py-3 md:p-5 shadow-[0_0_2px_0_rgba(0,0,0,0.25)]">
          <h1 className="text-[2rem] font-medium leading-7 mb-2 text-textClr/40">
      ...
      {/* Search Bar */}
      <div className="mt-4 md:mt-10.5">
        <h1 className="font-medium text-[1.75rem] text-textClr mb-3 md:mb-6.5">
      ...
      <div className="w-full mt-3 md:mt-4 overflow-y-auto h-[500px]">
        {users.map((emp) => (
          ...
          >
            {/* Left: Profile Info */}
            <div className="flex items-center gap-2 md:gap-4 min-h-[40px]">
              <div
                className={`${
                  visibleUsers[emp.id]
                    ? "opacity-100 visible"
